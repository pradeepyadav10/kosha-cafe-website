  ...
  return (
    <div className="container my-5">
      ...
      <div className="row">
        ...
        <div className="col-md-4 mb-3">
          <img
            src="https://images.unsplash.com/photo-1647277456251-4bd177988dcf?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Y29mZmVlJTIwY2FmZSUyMGF5dXJ2ZWRpYyUyMHNob3BzfGVufDB8fDB8fHww"
            alt="Coffee Beans"
            className="img-fluid rounded"
          />
        </div>
        ...
        {team.map(member => (
          <div className="col" key={member.id}>
            <div className="card h-100 shadow-sm text-center">
              <img src={member.image} className="card-img-top rounded-circle mx-auto mt-3" alt={member.name} style={{width: '120px', height: '120px', objectFit: 'cover'}} />
