        ...
        <>
          <div className="list-group mb-4">
            {Object.values(cart).map(item => (
              <div key={item.id} className="list-group-item d-flex align-items-center border-0 border-bottom p-3" style={{ backgroundColor: beigeBg }}>
                ...
                <div className="text-end" style={{ minWidth: '100px', whiteSpace: 'nowrap', overflowWrap: 'break-word', wordWrap: 'break-word' }}>
